...
import io.github.cursodsousa.icompras.faturamento.subscriber.representation.DetalheItemProdutoRepresentation;
...
public class PedidoMapper {
    ...
    private ItemPedido mapItem(DetalheItemProdutoRepresentation representation) {
        return new ItemPedido(
                representation.codigoProduto(),
                representation.nome(),
                representation.valorUnitario(),
                representation.quantidade(),
                representation.getValorTotal()
        );
